...
import gretel_client._api.models

from gretel_client._api import rest
from gretel_client._api.api_response import ApiResponse
from gretel_client._api.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gretel_client._api.models, klass)
