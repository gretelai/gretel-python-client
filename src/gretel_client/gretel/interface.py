...
class Gretel:
    ...
    def __init__(
        ...
        **session_kwargs,
        ...
        self._factories: Optional[GretelFactories] = None
    ...
    @property
    def factories(self) -> GretelFactories:
        """Returns the GretelFactories object for creating new objects."""
        if self._factories is None:
            self._factories = GretelFactories()
