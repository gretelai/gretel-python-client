...
class ServerlessApi:
    ...
    @validate_call
    def create_serverless_tenant(
        self,
        create_serverless_tenant_request: CreateServerlessTenantRequest,
        ...
        """create_serverless_tenant


        :param create_serverless_tenant_request: (required)
        :type create_serverless_tenant_request: CreateServerlessTenantRequest
        ...
        _param = self._create_serverless_tenant_serialize(
            create_serverless_tenant_request=create_serverless_tenant_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "CreateServerlessTenantResponse",
        }
    ...
    @validate_call
    def create_serverless_tenant_with_http_info(
        self,
        create_serverless_tenant_request: CreateServerlessTenantRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateServerlessTenantResponse]:
        """create_serverless_tenant
    ...
    @validate_call
    def create_serverless_tenant_without_preload_content(
        self,
        create_serverless_tenant_request: CreateServerlessTenantRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_serverless_tenant_serialize(
        self,
        create_serverless_tenant_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_serverless_tenant_request is not None:
            _body_params = create_serverless_tenant_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v1/serverless/tenants",
    ...
    def delete_serverless_tenant(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "DeleteServerlessTenantResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    def delete_serverless_tenant_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteServerlessTenantResponse]:
        """delete_serverless_tenant
    ...
    def list_serverless_tenants(
        ...
        _param = self._list_serverless_tenants_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ListServerlessTenantsResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def list_serverless_tenants_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListServerlessTenantsResponse]:
        """list_serverless_tenants
    ...
    @validate_call
    def list_serverless_tenants_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_serverless_tenants_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def poll_serverless_tenants(
        self,
        cell_id: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._poll_serverless_tenants_serialize(
            cell_id=cell_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "PollServerlessTenantsResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    def poll_serverless_tenants_with_http_info(
        self,
        cell_id: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PollServerlessTenantsResponse]:
        """poll_serverless_tenants
    ...
    @validate_call
    def poll_serverless_tenants_without_preload_content(
        self,
        cell_id: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _poll_serverless_tenants_serialize(
        self,
        cell_id,
        _request_auth,
        _content_type,
        ...
        if cell_id is not None:
            ...
            _query_params.append(("cell_id", cell_id))
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/v1/serverless/tenants/poll",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_serverless_tenant(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "UpdateServerlessTenantResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    def update_serverless_tenant_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateServerlessTenantResponse]:
        """update_serverless_tenant
    ...
    def _update_serverless_tenant_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_serverless_tenant_request is not None:
            _body_params = update_serverless_tenant_request
