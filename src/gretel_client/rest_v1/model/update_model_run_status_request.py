...
class UpdateModelRunStatusRequest(ModelNormal):
    ...
    attribute_map = {
        "model_run_id": "model_run_id",  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, model_run_id, status, *args, **kwargs):  # noqa: E501
        """UpdateModelRunStatusRequest - a model defined in OpenAPI
