...
class UpdateWorkflowRunStatusRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, workflow_run_id, status, *args, **kwargs):  # noqa: E501
        """UpdateWorkflowRunStatusRequest - a model defined in OpenAPI
