...
def lazy_import():
    ...
    globals()["WorkflowRunCancellationRequest"] = WorkflowRunCancellationRequest


class WorkflowRun(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "cancellation_request": (WorkflowRunCancellationRequest,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, workflow_id, *args, **kwargs):  # noqa: E501
