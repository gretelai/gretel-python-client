...
class ClusterStatus(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["health_status"]
    ...
    def health_status_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('HEALTH_STATUS_UNKNOWN', 'HEALTH_STATUS_HEALTHY', 'HEALTH_STATUS_DEGRADED', 'HEALTH_STATUS_UNHEALTHY')"
            )
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"health_status": obj.get("health_status")})
        return _obj
