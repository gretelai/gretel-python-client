...
class ConfigTenantLimits(BaseModel):
    """
    TenantLimits is the limits that we set for a tenant.
    """  # noqa: E501

    max_parallel_workflows: Optional[StrictInt] = Field(
        default=None,
        description="Max number of concurrent workflows that can be run in parallel.",
    )
    max_total_workflows: Optional[StrictInt] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigTenantLimits from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigTenantLimits from a dict"""
        if obj is None:
            return None
