...
class GoogleProtobufAny(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GoogleProtobufAny:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GoogleProtobufAny:
        """Create an instance of GoogleProtobufAny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GoogleProtobufAny.parse_obj(obj)

        _obj = GoogleProtobufAny.parse_obj({"type": obj.get("@type")})
