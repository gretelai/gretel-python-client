...
class PollServerlessTenantsResponse(BaseModel):
    """
    PollServerlessTenantsResponse
    """  # noqa: E501

    tenants: Optional[List[ServerlessTenant]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PollServerlessTenantsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PollServerlessTenantsResponse from a dict"""
        if obj is None:
            return None
