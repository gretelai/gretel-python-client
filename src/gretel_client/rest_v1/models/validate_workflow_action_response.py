...
class ValidateWorkflowActionResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidateWorkflowActionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidateWorkflowActionResponse:
        """Create an instance of ValidateWorkflowActionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidateWorkflowActionResponse.parse_obj(obj)

        _obj = ValidateWorkflowActionResponse.parse_obj(
