...
from gretel_client_v2.cli.common import SessionContext, pass_session, project_option
...
@click.option("--all", default=False, is_flag=True, help="Delete all project artifacts")
@project_option
@pass_session
