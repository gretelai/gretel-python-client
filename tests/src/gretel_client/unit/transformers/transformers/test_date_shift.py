...
def test_date_shift():
    ...
    date_config = DateShiftConfig(secret='2B7E151628AED2A6ABF7158809CF4F3CEF4359D8D580AA4F7F036D6F04FC6A94',
                                  lower_range_days=-10, upper_range_days=45, labels=['date'])

    date_config_tweak = DateShiftConfig(secret='2B7E151628AED2A6ABF7158809CF4F3CEF4359D8D580AA4F7F036D6F04FC6A94',
                                        lower_range_days=-10, upper_range_days=45, labels=['date'],
                                        tweak=FieldRef('test_id'))

    date2_config = DateShiftConfig(secret='1628AED2A6A809CBF7158F7F036D6F059D8D54FC6A942B7E15F4F3CEF4380AA4',
                                   lower_range_days=-10, upper_range_days=45, labels=['date'])

    date2_config_tweak = DateShiftConfig(secret='1628AED2A6A809CBF7158F7F036D6F059D8D54FC6A942B7E15F4F3CEF4380AA4',
                                         lower_range_days=-10, upper_range_days=45, labels=['date'])
